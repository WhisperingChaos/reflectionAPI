...
function CmmdElemLiteralModule ( constLiteral) {
	CmmdElemModule.call( this, new CmmdElemLiteral( constLiteral))
}
...
function CmmdElemVariableModule () {
	CmmdElemModule.call( this, new CmmdElemVariable())
}
...
function CmmdHTTPgetModule(){
	CmmdModule.call( this, new CmmdHTTPget())	
}
